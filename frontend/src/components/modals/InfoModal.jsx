    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="px-10 py-8 flex items-center justify-between bg-white">
                    ...
                    <button
                        onClick={onClose}
                        className="w-12 h-12 rounded-full bg-gray-50 flex items-center justify-center text-gray-400 hover:bg-gray-100 hover:text-gray-900 transition-all shadow-sm border border-gray-100"
                ...
                <div className="p-2 md:p-6 overflow-y-auto custom-scrollbar bg-white">
