...
const EditProfileModal = ({ isOpen, onClose, user, onUpdate }) => {
    ...
    useEffect(() => {
        console.log("EditProfileModal State Update:", { state: formData.state, district: formData.district, city: formData.city, latitude, longitude });
    }, [formData.state, formData.district, formData.city, latitude, longitude]);
    ...
    const fetchLocation = async () => {
        ...
        try {
            ...
            // Flag to ignore subsequent effect
