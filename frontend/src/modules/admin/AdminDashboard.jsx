...
export default function AdminDashboard() {
    ...
    const handleViewOrg = async (id) => {
        setLoading(true);
        try {
            const res = await axios.get(`http://localhost:4000/api/admin/organizations/${id}`, getAuthConfig());
    ...
    const handleViewDonor = async (id) => {
        setLoading(true);
        try {
            const res = await axios.get(`http://localhost:4000/api/admin/donors/${id}`, getAuthConfig());
    ...
    const handleViewReport = async (id) => {
        setLoading(true);
        try {
            const res = await axios.get(`http://localhost:4000/api/admin/reports/${id}`, getAuthConfig());
    ...
    const handleAddAdmin = async (e) => {
        e.preventDefault();
        try {
            await axios.post('http://localhost:4000/api/admin/admins', newAdmin, getAuthConfig());
    ...
    const handleDeleteAdmin = async (id) => {
        ...
        try {
            await axios.delete(`http://localhost:4000/api/admin/admins/${id}`, getAuthConfig());
    ...
    const handleBroadcast = async (e) => {
        ...
        try {
            await axios.post('http://localhost:4000/api/admin/notifications', broadcast, getAuthConfig());
                ...
                <div className="grid grid-cols-2 gap-12 mb-12">
                    <div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="pt-2">
                                <span className="bg-red-50 text-red-600 px-3 py-1 rounded-lg font-black text-sm">Blood Group: {report.donor_blood_type}</span>
                            </div>
                        </div>
                    </div>
                    <div className="text-right">
