    ...
    'mobile-app': {
      ...
      content: (
        <div className="animate-in fade-in zoom-in-95 duration-500">
          <div className="bg-[#dc2626] rounded-[2.5rem] p-4 md:p-6 relative overflow-hidden group shadow-2xl shadow-red-500/20">
            <div className="absolute -top-16 -right-16 w-64 h-64 bg-white/10 rounded-full blur-[80px]"></div>
            <div className="absolute -bottom-16 -left-16 w-64 h-64 bg-black/10 rounded-full blur-[60px]"></div>

            <div className="flex flex-col lg:flex-row items-center gap-4 relative z-10">
              {/* Left Side: Mockup — enlarged */}
              <div className="lg:w-5/12 flex justify-center relative">
                ...
                <img
                  ...
                  className="w-52 md:w-72 relative z-10 drop-shadow-[0_30px_60px_rgba(0,0,0,0.4)] transition-transform duration-700 group-hover:scale-105"
                />
              </div>

              {/* Right Side */}
              <div className="lg:w-7/12 text-center lg:text-left text-white">
                <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-xl px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-[0.2em] mb-3 border border-white/20 shadow-xl">
                  <span className="w-2 h-2 bg-green-400 rounded-full animate-pulse shadow-[0_0_12px_rgba(74,222,128,0.5)]"></span>
                  Ready on Stores
                </div>

                <h3 className="text-2xl md:text-3xl font-black mb-2 leading-[1.05] tracking-tighter uppercase">
                  Power <span className="text-white/90">In Your</span> <br />
                  <span className="text-white/80">Pocket</span>
                </h3>

                <p className="text-red-50/90 font-bold text-xs mb-4 leading-relaxed opacity-90">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
                  ...
                  <div className="flex flex-col gap-2 w-full sm:w-auto">
                    <a href="#" className="flex items-center gap-3 bg-white text-gray-900 px-5 py-2.5 rounded-2xl hover:bg-gray-50 transition-all font-black text-[10px] uppercase tracking-widest shadow-xl group/btn">
                      ...
                      <div className="text-left">
                        <span className="text-[8px] block text-gray-400 leading-none mb-0.5">Download on</span>
                    ...
                    <a href="#" className="flex items-center gap-3 bg-gray-900 border border-white/10 text-white px-5 py-2.5 rounded-2xl hover:bg-black transition-all font-black text-[10px] uppercase tracking-widest shadow-xl group/btn2">
                      ...
                      <div className="text-left">
                        <span className="text-[8px] block text-gray-400 leading-none mb-0.5">Get it on</span>
                        <span className="text-xs leading-none">Google Play</span>
                      </div>
                    </a>
                  </div>
                </div>
